...
This workflow was developed with **N8N** as the agent orchestrator and the multimodal **Google Gemini 3.1 Pro** LLM with **Gmail** enabled for tool use. It's also capable of respecting privacy permissions and anonymizing personally identifiable information.

---

## Core Features
* **Multimodal Transcription:** Transcribe audio from `.mp4` files and convert into text using **Gemini 3.1 Pro**.
